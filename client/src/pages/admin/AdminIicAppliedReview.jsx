...
import { getAdminIicAppliedReviewQueue } from "../../../config/api";
import Alert from "../../components/Alert";
import SearchableSelect from "../../components/SearchableSelect";
import { getAuthToken } from "../../utils/auth";

export default function AdminIicAppliedReview() {
  ...
  useEffect(() => {
    const loadQueue = async () => {
      setLoading(true);
      try {
        const payload = await getAdminIicAppliedReviewQueue(token);
    ...
    <section className="min-h-[calc(100vh-4rem)] bg-gray-50">
      <div className="border-b border-gray-200 bg-white px-8 py-8">
        <div className="space-y-2">
          <h1 className="heading-xl">IIC Applied Review Queue</h1>
          <p className="text-muted">Review pending and rejected IIC Applied entries</p>
        </div>
      </div>
