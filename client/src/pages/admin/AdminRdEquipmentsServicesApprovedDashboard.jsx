...
import {
  getAdminApprovedRdEquipmentsServices,
  getAdminApprovedRdEquipmentsServicesFilterOptions,
...
export default function AdminRdEquipmentsServicesApprovedDashboard() {
    ...
    const loadInitialData = async () => {
      ...
      try {
        const [servicesPayload, optionsPayload] = await Promise.all([
          getAdminApprovedRdEquipmentsServices({ token, includeRejected: true }),
          getAdminApprovedRdEquipmentsServicesFilterOptions(token, { includeRejected: true }),
        ]);
      ...
      <div className="border-b border-gray-200 bg-white px-8 py-8">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2">
            ...
            <p className="text-muted">Review approved and rejected R & D Equipments Services entries</p>
          </div>
          <Link
