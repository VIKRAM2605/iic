      ...
      <div className="border-b border-gray-200 px-6 py-6">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="space-y-1">
            <h1 className="text-2xl font-semibold tracking-tight text-slate-900 sm:text-[28px]">Events Dashboard</h1>
            <p className="text-sm text-[#7a80a6] sm:text-base">Track and manage your events submissions</p>
          </div>
