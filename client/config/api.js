...
export const API_ROUTES = {
  ...
  adminApprovedFilterOptions:
    "/api/event-details/admin/approved/filter-options",
  ...
  adminApprovedIdeaFilterOptions:
    "/api/idea-details/admin/approved/filter-options",
  ...
  adminApprovedPrototypeFilterOptions:
    "/api/prototype-details/admin/approved/filter-options",
  ...
  adminApprovedBusinessFilterOptions:
    "/api/business-details/admin/approved/filter-options",
...
export const API_URLS = {
  ...
  adminApprovedIdeaFilterOptions: getApiUrl(
    API_ROUTES.adminApprovedIdeaFilterOptions,
  ),
  ...
  adminApprovedPrototypeFilterOptions: getApiUrl(
    API_ROUTES.adminApprovedPrototypeFilterOptions,
  ),
  ...
  adminApprovedBusinessFilterOptions: getApiUrl(
    API_ROUTES.adminApprovedBusinessFilterOptions,
  ),
...
export const getAdminApprovedEvents = async ({
  token,
  quarter,
  date,
  fromDate,
  ...
  const response = await fetch(
    `${API_URLS.adminApprovedEvents}?${params.toString()}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getAdminApprovedIdeas = async ({
  ...
  const response = await fetch(
    `${API_URLS.adminApprovedIdeas}?${params.toString()}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getAdminApprovedPrototypes = async ({
  ...
  const response = await fetch(
    `${API_URLS.adminApprovedPrototypes}?${params.toString()}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getAdminApprovedIdeaFilterOptions = async (
  token,
  { includeRejected } = {},
) => {
  const params = new URLSearchParams();
...
export const getAdminApprovedPrototypeFilterOptions = async (
  token,
  { includeRejected } = {},
) => {
  const params = new URLSearchParams();
  ...
  return parseJsonResponse(
    response,
    "Failed to fetch prototype filter options.",
  );
};

export const reviewEventByAdmin = async ({
  token,
  eventId,
  action,
  rejectionMessage = "",
...
export const reviewIdeaByAdmin = async ({
  token,
  ideaId,
  action,
  rejectionMessage,
  ...
  const response = await fetch(
    `${API_URLS.ideaDetails}/admin/${ideaId}/review`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
...
export const reviewPrototypeByAdmin = async ({
  token,
  prototypeId,
  action,
  rejectionMessage,
  ...
  const response = await fetch(
    `${API_URLS.prototypeDetails}/admin/${prototypeId}/review`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
  ...
  return parseJsonResponse(
    response,
    "Failed to update prototype review status.",
  );
};
...
export const getAdminApprovedBusinesses = async ({
  ...
  const response = await fetch(
    `${API_URLS.adminApprovedBusinesses}?${params.toString()}`,
    {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
...
export const getAdminApprovedBusinessFilterOptions = async (
  token,
  { includeRejected } = {},
) => {
  const params = new URLSearchParams();
  ...
  return parseJsonResponse(
    response,
    "Failed to fetch business filter options.",
  );
};

export const reviewBusinessByAdmin = async ({
  token,
  businessId,
  action,
  rejectionMessage,
  ...
  const response = await fetch(
    `${API_URLS.businessDetails}/admin/${businessId}/review`,
    {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
  ...
  return parseJsonResponse(
    response,
    "Failed to update business review status.",
  );
};
